...
########################################################
CSV_PATH = "/path/to/your/cleaned_data.csv"
CONNECTOME_PATH = "/path/to/your/connectome.csv"

ID_COL = "subj_id"
TIME_COL = "time"  # assumed already in years
X_COLS = ["roiA", "roiB", "roiC"]  # <-- select your biomarker columns here
CLINICAL_COLS = []  # beta-init predictors, if any (leave [] if unused)
METADATA_COLS = []  # passthrough columns, if any
...
EXPERIMENT_CONFIG = {
    ...
    "param_grid_hyper": {
        ...
        "lambda_cog": [0.0],
        "lambda_scalar": [10.0, 20.0],
        "scalar_K_center": [1e-4, 1e-2, 1.0],
        "lambda_jsd": [10.0, 50.0],
        "lambda_beta": [0.0],
    },
}
# =============================================================================
